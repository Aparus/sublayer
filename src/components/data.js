const movieData = {
  ...
  scenes: {
    ...
    0: {
      ...
      phrases: {
        0: { id: "0", actor: "Dinesh", timeStart: 0, timeEnd: 3, text: "I'm Dinesh" },
        1: { id: "1", actor: "Jared", timeStart: 3, timeEnd: 6, text: "I'm Jared" },
        2: { id: "2", actor: "Richard", timeStart: 6, timeEnd: 9, text: "I'm Richard" },
        3: { id: "3", actor: "Monica", timeStart: 9, timeEnd: 12, text: "I'm Monica" }
      }
    },
    /* INFO FOR ONE SCENE */
    1: {
      ...
      phrases: {
        4: { id: "4", actor: "Dinesh", timeStart: 0, timeEnd: 3, text: "Scene 2, phrase 1" },
        5: { id: "5", actor: "Jared", timeStart: 3, timeEnd: 6, text: "phrase 2" },
        6: { id: "6", actor: "Dinesh", timeStart: 6, timeEnd: 9, text: "phrase 3" },
        7: { id: "7", actor: "Jared", timeStart: 9, timeEnd: 12, text: "phrase 4" }
      }
    },
    /* INFO FOR ONE SCENE */
    2: {
      ...
      phrases: {
        8: { id: "8", actor: "Gilfoyl", timeStart: 0, timeEnd: 3, text: "I'm Gilfoyl" },
        9: { id: "9", actor: "Erlich", timeStart: 3, timeEnd: 6, text: "I'm Erlich" },
        10: { id: "10", actor: "Gilfoyl", timeStart: 6, timeEnd: 9, text: "How are you?" },
        11: { id: "11", actor: "Erlich", timeStart: 9, timeEnd: 12, text: "I'm fine, thanks" }
      }
    }
  }
};
